            ...
            <div class="flex">
                ...
                <div class="flex items-center shrink-0">
                    <a href="/" class="flex ml-2 md:mr-24">
                        ...
                        <span class="self-center text-xl font-light sm:text-2xl whitespace-nowrap dark:text-white">
                            sigma</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="url('/users')" :active="Request::is('users')">
                                    {{ __('Todos Usuários') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="url('/users/create')" :active="Request::is('users/create')">
