...
<body>
    ...
    <div name="header">
        <h2 class="font-semibold text-2xl leading-tight">
            {{ __('Triagem página inicial tabela') }}
        </h2>
    </div>

    <div class="p-5 shadow-md rounded-md bg-white grid justify-items-center">
        <div class="max-w-5xl bg-white shadow-md rounded-md">
            <div class="p-2">
                <a type="button" class="btn btn-primary" href="{{url('triagem/terms/nova')}}">Nova</a>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="flex">
                                    ...
                                    <form action="{{ url('triagem/terms/' . $term->id) }}" method="post">
                                        {{ method_field('DELETE') }}
                                        @csrf
                                        <button type="submit" for="my-modal-6"
                                            class="btn btn-error mx-2 cursor-pointer">
