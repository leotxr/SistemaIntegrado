    ...
    <div class="my-2">
        ...
        <ol class="items-center w-full space-y-4 sm:flex sm:space-x-8 sm:space-y-0">
            <li class="flex items-center text-{{$color}}-600 dark:text-{{$color}}-500 space-x-2.5">
                ...
                <span>
                    <h3 data-modal-target="popup-modal-{{$file_type}}" data-modal-toggle="popup-modal-{{$file_type}}"
                        class="font-medium leading-tight">{{$title}}</h3>
        ...
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div  class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Tem certeza que deseja assinar
                        e aceitar o termo de {{$title}}?</h3>
                    <a type="button" wire:click.prevent='{{$wire_function}}' data-modal-hide="popup-modal-{{$file_type}}" 
                    ...
                    <button data-modal-hide="popup-modal-{{$file_type}}" type="button"
