<div class="justify-center">
                    ...
                    <div class="max-w-full">
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 content-center">
                            <div>
                                ...
                                <x-text-input type="date" wire:model.defer='date' id="date"
                                              class="input border-gray-300"></x-text-input>
                            </div>
                            <div>
                                <label for="setores"
                                ...
                                <div id="setores">
                                    ...
                                    <div class="flex items-center mb-4">
                                        <input wire:model.defer='sec' id="default-checkbox" type="checkbox" value="52"
                                               name="sec[]"
                                               class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                        <label for="default-checkbox"
                                               class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ressonância Subsolo</label>
                                    </div>
                            ...
                            <div>
                                <label for="export"
                                       class="label text-gray-900 dark:text-gray-50 font-light text-sm">Exportar para
                                    Excel</label>
                                <x-primary-button id="export" wire:click="export"
    ...
    <div class="bg-white dark:bg-gray-800 overflow-x-auto shadow-sm w-full mt-2">
        {{$pacientes->links()}}
        <x-table>
            <!-- head -->
            ...
            <x-slot:body>
                ...
                @foreach ($pacientes as $paciente)
                    ...
                    <x-table.row class="text-xs">
                        <x-table.cell
                                class="{{ $color }}">{{ date('d/m/Y', strtotime($paciente->DATA)) }}</x-table.cell>
                ...
                <div class="grid grid-cols-2 gap-4 text-center">
                    ...
                    <dl class="max-w-md text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                        <div class="flex flex-col pb-3 border-2 rounded-md">
                            ...
                            <dd class="text-md font-semibold">@if($showing->finished == 1)
                                    Finalizada
                                @else
                                    Não
                                    Finalizada
