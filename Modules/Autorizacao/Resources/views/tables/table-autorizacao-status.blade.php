                ...
                <tr>
                    ...
                    <td class="flex">
                        ...
                        <form action="{{ url('/destroy_exam/' . $protocols->id) }}" method="post">
                            {{ method_field('DELETE') }}
                            @csrf
                            <label for="my-modal-6" class="btn btn-error mx-2 cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="modal modal-bottom sm:modal-middle">
                                <div class="modal-box">
                                    <h3 class="font-bold text-lg">Deseja excluir este exame?</h3>
                                    <p class="py-4">A solicitação será apagada do sistema</p>
                                    <div class="modal-action">
                                        <label for="my-modal-6" class="btn btn-ghost">Fechar</label>
                                        <button type="submit" for="my-modal-6" class="btn btn-error">Confirmar</label>
                                    </div>
                                </div>
                            </div>
