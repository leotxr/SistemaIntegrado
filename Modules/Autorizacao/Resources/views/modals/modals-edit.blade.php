...
<x-modal.form wire:model.defer="modalExam" maxWidth="5xl">
    ...
    <x-slot name="content">
        ...
        @if(auth()->user()->cant('excluir autorizacao')) @php $isDisabled = true; @endphp @else @php $isDisabled =
        false; @endphp @endif
        @php
        ...
        <div wire:key="exam-field-{{$exam->id}}" class="p-4 mb-2 border-2 border-gray-300 rounded-md">
            ...
            <div class="grid grid-cols-1 gap-2 mx-2 sm:grid-cols-6">
                ...
                <div class="col-span-1 mt-4 sm:col-span-2">
                    ...
                    <x-text-input type="date" name='exam_date' disabled='{{$isDisabled}}' class="block w-full input"
                ...
                <div class="col-span-1 mt-4 sm:col-span-2">
                    ...
                    <x-text-input type="text" name='convenio' disabled='{{$isDisabled}}' class="block w-full input"
