    ...
    @if (auth()->user())
        ...
        @if (auth()->user()->can('admin') ||
            ...
            <div class="py-12 shadow-md bg-base-100" id="teste">
                <div class="mx-auto max-w-screen-7xl sm:px-6 lg:px-8">
                    <div class="overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 ">
                            <div class="grid grid-cols-1 gap-4 font-bold sm:grid-cols-5">

                                <div data-value="1" class="cursor-pointer btn-status active:scale-95">
                                    <div class="rounded-lg shadow-md stat max-h-auto bg-error">
                                        <div class="stat-title">Exames Urgentes</div>
                                        <div class="stat-value text-error-content">{{ $urgentes }}</div>
                                    </div>
                                </div>

                                <div data-value="2" class="cursor-pointer btn-status active:scale-95">
                                    <div class="rounded-lg shadow-md stat max-h-auto bg-warning">
                                        <div class="stat-title">Exames Pendentes</div>
                                        <div class="stat-value text-warning-content">{{ $pendentes }}</div>
                                    </div>
                                </div>

                                <div data-value="3" class="cursor-pointer btn-status active:scale-95">
                                    <div class="rounded-lg shadow-md stat max-h-auto bg-success">
                                        <div class="stat-title">Autorizados/Negados</div>
                                        <div class="stat-value text-success-content">{{ $autneg }}</div>
                                    </div>
                                </div>

                                <div data-value="4" class="cursor-pointer btn-status active:scale-95">
                                    <div class="rounded-lg shadow-md stat max-h-auto bg-neutral-content">
                                        <div class="stat-title">Analise</div>
                                        <div class="stat-value text-neutral">{{ $analise }}</div>
                                    </div>
                                </div>

                                <div data-value="5" class="cursor-pointer btn-status active:scale-95">
                                    <div class="rounded-lg shadow-md stat max-h-auto bg-secondary">
