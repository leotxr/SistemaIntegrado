            ...
            <div class="grid grid-cols-1 sm:grid-cols-6 gap-4">
                        ...
                        <ul
                            ...
                            <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                <div class="flex items-center pl-3">
                                    <x-text-input wire:model.defer='activeStatus' id="status-{{ $status->id }}"
                                        type="checkbox" name="activeStatus[]" value="{{ $status->id }}"
                ...
                @can('excluir autorizacao')
                    <div class="border-2 p-4 col-span-1 sm:col-span-2">
                        ...
                        @foreach ($usersCriar as $user)
                            <ul
                                class="w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        <x-text-input wire:model.defer='selectedUsers' id="user-{{ $user->id }}"
                                            name="selectedUsers[]" type="checkbox" value="{{ $user->id }}"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
                    ...
                    <div class="border-2 p-4 col-span-1 sm:col-span-2">
                        ...
                        @foreach ($usersEditar as $user)
                            <ul
                                class="w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        <x-text-input wire:model.defer='selectedUpdaters' id="updater-{{ $user->id }}"
                                            name="selectedUpdaters[]" type="checkbox" value="{{ $user->id }}"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
