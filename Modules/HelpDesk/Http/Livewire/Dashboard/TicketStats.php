...
class TicketStats extends Component
{
    ...
    public function render()
    {
        ...
        $tma_ontem = gmdate("H:i:s", Ticket::whereBetween('ticket_open', [date('Y-m-d 00:00:00', strtotime("-1 days")), date('Y-m-d 23:59:59', strtotime("-1 days"))])->whereNotNull('ticket_close')->avg('total_ticket'));
        $tma_7d = gmdate("H:i:s", Ticket::whereBetween('ticket_open', [date('Y-m-d 00:00:00', strtotime("-6 days")), date('Y-m-d 23:59:59')])->whereNotNull('ticket_close')->avg('total_ticket'));
