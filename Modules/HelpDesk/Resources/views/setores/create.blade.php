<div class="p-10 bg-white dark:bg-gray-800">
    <h1 class="mb-2 text-xl font-bold text-gray-900 dark:text-white">Cadastrar novo Setor</h1>
    <form>
        <div class="mb-6">
            <label for="setor_nome" class="block mb-2 text-sm font-bold text-gray-900 dark:text-white">Nome</label>
            <input type="text" id="setor_nome" name="setor_nome"
