    ...
    <x-slot name='content'>
        ...
        <div class="grid grid-cols-2 gap-3">
            <div class="mt-4">
                ...
                <input type="datetime-local" step='1' class="input dark:bg-gray-700 dark:text-gray-100" name="ticket_start" id="ticket_start" wire:model.defer='finishing.ticket_start' />
                <x-input-error class="mt-2" :messages="$errors->get('finishing.ticket_start')" />
            </div>
            <div class="mt-4">
                <x-input-label for="exam" :value="__('Hora de Finalização')" />
                <input type="datetime-local" step='1' value="{{$ticket_close}}" class="input dark:bg-gray-700 dark:text-gray-100" name="ticket_close" id="ticket_close" />
