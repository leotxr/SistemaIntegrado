<div>
    <div class="w-full px-4 py-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <x-title>Usuários que mais relataram</x-title>
        <span class="text-xs font-light text-gray-500">Exibe os 5 usuários que mais relataram Não Conformidades no período.</span>
        <x-table>
            <x-slot name="head">
