...
@php
    $classes = ($active ?? false)
                ...
                : 'inline-flex items-center px-1 pt-2 pb-2 border-l-4 border-transparent text-md font-medium leading-5 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300 dark:hover:border-blue-400 focus:outline-none focus:text-gray-700 dark:focus:text-gray-300 focus:border-gray-300 dark:focus:border-blue-500 transition duration-150 ease-in-out';
@endphp
