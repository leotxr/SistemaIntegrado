<div id="accordion-flush" class="rounded-sm border" x-data="{open: true}">
    <h2 id="accordion-flush-heading-1">
        <div
            class="flex items-center justify-between w-full font-medium text-left dark:text-gray-400 bg-gray-800 p-2  ">
